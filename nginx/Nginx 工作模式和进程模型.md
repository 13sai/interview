...
PS:nginx使用到的进程间通信机制有三种，信号(操作系统与master)、套接字(master进程和worker进程)、共享内存(worker进程之间)。
...
- [nginx进程间通信机制](https://z.itpub.net/article/detail/FAA99E6645C76C7514F49E982062CE96)
